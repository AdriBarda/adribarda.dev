...
links:
  - repository: ai-job-search
    owner: MadsLorentzen
    repositoryUrl: https://github.com/MadsLorentzen/ai-job-search
    project: A local-first job search framework built on Claude Code that evaluates postings, tailors CVs, and writes cover letters.
    stars: 26.3k
    language: TypeScript
    license: MIT
